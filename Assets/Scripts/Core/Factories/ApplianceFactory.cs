...
namespace Core.Factories
{
    public class ApplianceFactory : ObjectFactory<Appliance>, IApplianceFactory
    {
        ...
        public Appliance GenerateAppliance(ApplianceType applianceType, int applianceLevel,
            Vector2Int applianceCoordinate)
        {
            ...
            appliance.SetAttributes(applianceCoordinate, applianceType, applianceLevel,
                applianceData.ApplianceLevelDataDict.Count);
